...
public class SemillaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerPerritos = (RecyclerView) vista.findViewById(R.id.recyclerIdSemilla);
        ...
        Call<JsonObject> call = service.getSemilla();
                    ...
                    try {
                        if (response.isSuccessful()) {
                            ...
                            for (int i = 0; i < jsonArray.length(); ++i) {
                                listaPerritos.add(new Perrito("Chihuahua", jsonArray.getString(i)));
                            }
                            ...
                            Log.d("Semilla", "" + listaPerritos.size());
                        } else {
                            Log.d("Semilla", "error else");
                        }
                    } catch (JSONException e) {
                        Log.d("Semilla", "error catch " + e);
                        e.printStackTrace();
                    }
                }
